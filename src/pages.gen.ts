...
type Page =
  ...
  | { path: '/contracts/MakinaLiteModule.sol/contract.MakinaLiteModule'; render: 'static' }
  ...
  | { path: '/contracts/interfaces/IMakinaLiteContext.sol/interface.IMakinaLiteContext'; render: 'static' }
  | { path: '/contracts/interfaces/IMakinaLiteGovernable.sol/interface.IMakinaLiteGovernable'; render: 'static' }
  | { path: '/contracts/interfaces/IMakinaLiteModule.sol/interface.IMakinaLiteModule'; render: 'static' }
  | { path: '/contracts/interfaces/IMakinaLiteRegistry.sol/interface.IMakinaLiteRegistry'; render: 'static' }
  ...
  | { path: '/contracts/registry/MakinaLiteRegistry.sol/contract.MakinaLiteRegistry'; render: 'static' }
  | { path: '/contracts/security'; render: 'static' }
  | { path: '/contracts/utils/MakinaLiteContext.sol/abstract.MakinaLiteContext'; render: 'static' }
  | { path: '/contracts/utils/MakinaLiteGovernable.sol/abstract.MakinaLiteGovernable'; render: 'static' }
  | { path: '/'; render: 'static' }
